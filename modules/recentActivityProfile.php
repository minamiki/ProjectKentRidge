<!-- This page is similar to recentActivity.php but there is additional paging
...
-javascript is used to toggle (hide/appear) the panel
-->
...
<div id="recent" class="framePanel rounded">
    ...
    <?php }else{ ?>
    	<!-- javascript toggle for hiding and expanding the panel -->
...
$(document).ready(function(){
	...
	//toggle for showing the clicked item
