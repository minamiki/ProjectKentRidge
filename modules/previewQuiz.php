...
<div id="takequiz-preamble" class="frame rounded">
  <h3>Take a quiz</h3>
  Here's some information about the quiz! You can decide whether to take this quiz. This quiz contains <strong><?php echo $quiz->numQuestions(); ?> questions</strong>. </div>
