...
<h3 id="title_quiz_result">Quiz Unpublished!</h3> 
You have successfully unpublished your quiz. Your quiz will not be listed in topics or search queries.</div>
...
You have successfully published your quiz. Your quiz will now be available under the topic <?php echo $quiz->category(); ?>. It will also turn up in search queries. You will start receiving points when users take your quiz! Good luck!
</div>
<div id="takequiz-preview" class="frame rounded">
  <h2><?php echo $quiz->quiz_name; ?></h2>
  <?php if($quiz->quiz_picture != "none.gif"){ ?>
