<!-- This page is to display the recent activity for both user and friends
     also including the user's current level and achievement
     javascript is used to toggle (hide/appear) the panel
-->

<?php require('../modules/quizrooDB.php'); //database connection ?>
 ...
 * - E.g. Sally just did ___ quiz and got ___ result
 * Type 1 : Achievements
 * - Recent achievements user received
 * - Recent achievements user's friends received
 * - E.g. Sally just got Explorer! of quizzes
 ***********************************/
