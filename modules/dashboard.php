      ...
      <?php if($totalRows_recommendations != 0){ do { ?>
        <div class="quiz_box clear">
          ...
          <div class="quiz_details">
            ...
            <p class="source">from <a href="topics.php?topic=<?php echo $row_recommendations['fk_quiz_cat']; ?>"><?php echo $row_recommendations['cat_name']; ?></a>  by <a href="javascript:featureUnavailable();"><?php echo $row_recommendations['member_name']; ?></a></p>
      ...
      <?php if($totalRows_popular !=0 ){ do { ?>
        <div class="quiz_box clear">
          ...
          <div class="quiz_details">
            ...
            <p class="source">from <a href="topics.php?topic=<?php echo $row_popular['fk_quiz_cat']; ?>"><?php echo $row_popular['cat_name']; ?></a> by <a href="javascript:featureUnavailable();"><?php echo $row_popular['member_name']; ?></a>
...
<a href="topics.php?topic=<?php echo $row_getTopics['cat_id']; ?>" class="topicTitle"><?php echo $row_getTopics['cat_name']; ?></a>
  ...
  <div id="social" class="frame rounded">
    <h2>Social</h2>
    <p>Visit our <a href="http://www.facebook.com/apps/application.php?id=154849761223760" target="_blank">facebook page</a> for updates! Discuss what you like about Quizroo!</p>
