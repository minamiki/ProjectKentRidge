...
$query_recommendations = "SELECT quiz_id, quiz_name, quiz_description, quiz_picture, member_name, cat_name FROM q_quizzes, q_quiz_cat, members WHERE member_id = fk_member_id AND cat_id = fk_quiz_cat ORDER BY creation_date DESC";
...
mysql_select_db($database_quizroo, $quizroo);
$query_popular = "SELECT quiz_id, quiz_name, quiz_description, quiz_picture, member_name, cat_name FROM q_quizzes, q_quiz_cat, members WHERE member_id = fk_member_id AND cat_id = fk_quiz_cat ORDER BY RAND()";
