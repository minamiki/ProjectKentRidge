...
$query_getTopicsAll = "SELECT * FROM q_quiz_cat";
...
<div id="dashboard-container">
  ...
  <div id="topics-bar" class="rounded clear">
  	<ul>
    <?php do { ?>
    <li><a href="topics.php?topic=<?php echo $row_getTopicsAll['cat_id']; ?>&bar" class="topicTitle"><?php echo $row_getTopicsAll['cat_name']; ?></a></li>
