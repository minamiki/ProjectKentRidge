<!--
This page is an interface to display a quiz for external user
Details of the quiz is displayed and direct the user to take quiz in Quizroo
If the quiz is not published and the user is the quiz owner=> prompt to publish the quiz
-->
<?php require('../modules/quizrooDB.php'); // database connection?>
<!-- If the quiz exists, display quiz picture and quiz information-->
<?php if($quiz->exists()){ ?>
...
<h2><?php echo $quiz->quiz_name; ?></h2>
  ...
  <!-- Display button for re-directing user to Quizroo to take quiz-->
...
<!-- If the user is quiz owner and the quiz is not published, alert the user to publish the quiz--> 
