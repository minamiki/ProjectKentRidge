...
<div id="created-preamble" class="frame rounded">
  ...
  <p><a href="http://apps.facebook.com/quizroo/previewQuiz.php?id=<?php echo $_GET['id']; ?>" target="_blank">http://apps.facebook.com/quizroo/previewQuiz.php?id=<?php echo $_GET['id']; ?></a></p>
  ...
  <span class="center">
  <input name="publishBtn2" type="button" class="orangeBtn" id="previewBtn" onclick="goToURL('previewQuiz.php?id=<?php echo $_GET['id']; ?>')" value="Preview Quiz" />&nbsp;
  <input name="publishBtn" type="button" id="publishBtn" onclick="goToURL('publishQuiz.php?id=<?php echo $_GET['id']; ?>')" value="Publish Quiz!" />
</span></div>
